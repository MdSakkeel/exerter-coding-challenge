...
with open(r'E:\spacezee\t8.shakespeare.txt', 'r') as f:
    input_text = f.read()

with open(r'E:\spacezee\find_words.txt', 'r') as f:
    find_words = set(f.read().split())

with open(r'E:\spacezee\french_dictionary.csv', 'r') as f:
    reader = csv.reader(f)
...
with open(r'E:\spacezee\t8.shakespeare.translated.txt', 'w') as f:
    f.write(output_text)
...
with open(r'E:\spacezee\performance.txt', 'w') as f:
...
with open(r'E:\spacezee\frequency.csv', 'w') as f:
